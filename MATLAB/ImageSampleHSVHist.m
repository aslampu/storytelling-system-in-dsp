...
subplot(2,2,2); hist([t1 t2], 50); title('H Channel');
t1 = blue_hsv_1(:,:,2); t1 = t1(:)'; t2 = blue_hsv_2(:,:,2); t2 = t2(:)';
subplot(2,2,3); hist([t1 t2], 50); title('S Channel');
t1 = blue_hsv_1(:,:,3); t1 = t1(:)'; t2 = blue_hsv_2(:,:,3); t2 = t2(:)';
subplot(2,2,4); hist([t1 t2], 50); title('V Channel');
...
subplot(2,2,2); hist(keyboard_hsv_1(:,:,1), 50); title('H Channel');
subplot(2,2,3); hist(keyboard_hsv_1(:,:,2), 50); title('S Channel');
subplot(2,2,4); hist(keyboard_hsv_1(:,:,3), 50); title('V Channel');


figure; hold on;
subplot(2,2,1); image(sample_wall_1); title('Wall Sample');
subplot(2,2,2); hist(wall_hsv_1(:,:,1), 50); title('H Channel');
subplot(2,2,3); hist(wall_hsv_1(:,:,2), 50); title('S Channel');
subplot(2,2,4); hist(wall_hsv_1(:,:,3), 50); title('V Channel');
